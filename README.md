...
```
docker run --platform linux/amd64 --name <CONTAINER_NAME> -d -e PASSWORD=ANYTHING -p 8787:8787 -v $PWD:/home/rstudio/cruz-tcr pgc-images.sbgenomics.com/childrens-bti/haydar-scrna:latest
```
