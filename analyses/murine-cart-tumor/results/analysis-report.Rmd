...
# Key takeaways
- Read depth per cell are pretty low across samples, with high ambient RNA contamination. This may stem from the trade off between 10X flex and chromium kits and would adversely affect the analysis for smaller cell populations.
